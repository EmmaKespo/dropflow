  ...
  return (
    <div className="space-y-6 animate-fade-in select-none">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center gap-2 border border-dashed border-neutral-300 bg-white p-12 text-center text-xs font-medium text-neutral-400 uppercase tracking-wider">
          <i className="fa-solid fa-magnifying-glass big-icon text-neutral-300"></i>
          <span>No database rows match your active search terms criteria keys.</span>
        </div>
      ) : (
